...
instance ToJSON TransactionInput where
  toJSON (TransactionInput (from, to) txInps) = object
...
instance FromJSON TransactionWarning where
  ...
  parseJSON (Object v) =
    ...
    <|> (TransactionNonPositivePay <$> (parseJSON =<< (v .: "account"))
                                   <*> (parseJSON =<< (v .: "asked_to_pay"))
                                   <*> (parseJSON =<< (v .: "of_token"))
                                   <*> (parseJSON =<< (v .: "to_payee")))
    <|> (TransactionPartialPay <$> (parseJSON =<< (v .: "account"))
                               <*> (parseJSON =<< (v .: "asked_to_pay"))
                               <*> (parseJSON =<< (v .: "of_token"))
                               <*> (parseJSON =<< (v .: "to_payee"))
                               <*> (parseJSON =<< (v .: "but_only_paid")))
